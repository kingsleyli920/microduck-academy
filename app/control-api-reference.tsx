...
const content = {
  'zh-CN': {
    ...
    scopePage: '本页：', scopePageNote: '当前 control.duck 解释器支持的全部可执行语法。', scopeDynamic: '动态动作：', scopeDynamicNote: 'move(ref) 可以加载 Hub 仓库或 HTTPS ONNX URL，因此社区策略没有固定总数。',
  ...
  en: {
    ...
    scopePage: 'This page: ', scopePageNote: 'Every executable construct supported by the current control.duck interpreter.', scopeDynamic: 'Dynamic motions: ', scopeDynamicNote: 'move(ref) loads Hub repositories or HTTPS ONNX URLs, so community policies have no fixed total.',
