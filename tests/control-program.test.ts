...
void test('parses nested feedback programs and preserves source lines', () => {
...
void test('every published API example is valid control.duck syntax', () => {
...
void test('rejects unsafe loop counts, observation indexes, and incomplete blocks', () => {
...
void test('accepts only the requested number of finite numeric arguments', () => {
